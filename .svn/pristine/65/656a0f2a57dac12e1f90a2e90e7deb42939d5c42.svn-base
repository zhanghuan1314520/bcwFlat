...
// import { wsCoordinate } from "../../utils/WSCoordinate.js";
let wsCoordinate = require('../../utils/WSCoordinate.js')
...
Page({
  ...
  onReady: function () {
    ...
    // if('2020-11-03 12:47:47' > '2020-11-02 18:03:03'){
      ...
      console.log("result.data.data.latitude....", result.data.data.lng)
    // if(result.data.data.createDate >= updateStatus_time){
      ...
      var result = wsCoordinate.transformFromBaiduToGCJ(result.data.data.lat, result.data.data.lng);
